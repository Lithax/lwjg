...
public class Elipse extends Drawable {
    private boolean filled;
    
    public Elipse(CFrame cframe, Vector2 vel, double angularVelocity, Vector2 accel, double angularAcceleration, Vector2 dim, Color initialColor, int zIndex, boolean filled) {
